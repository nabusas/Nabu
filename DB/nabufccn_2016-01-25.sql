...
# Database: nabufccn
# Generation Time: 2016-01-25 16:14:18 +0000
# ************************************************************
...
CREATE TABLE `nb_cobrosm_vw` (
   `Fecha` VARCHAR(23) NULL DEFAULT NULL,
   `tipo` VARCHAR(255) NULL DEFAULT NULL,
   `tarifa` VARCHAR(255) NULL DEFAULT NULL,
   `Vehiculos` BIGINT(21) NOT NULL DEFAULT '0',
   `Valor` VARCHAR(82) NULL DEFAULT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `nb_control_tbl` (
  ...
  `nb_estado_fld` int(1) DEFAULT NULL,
  PRIMARY KEY (`nb_id_fld`)
...
INSERT INTO `nb_control_tbl` (`nb_id_fld`, `nb_1_tipo_vehi_fld`, `nb_2_placa_fld`, `nb_3_tarjeta_fld`, `nb_3_fecha_ingreso_fld`, `nb_4_fecha_salida_fld`, `nb_1_tipotarifa_fld`, `nb_5_totalhoras_fld`, `nb_6_valor_fld`, `nbd_id_user_fld`, `nb_estado_fld`)
VALUES
	(1,0,'KCS973',1,'2015-12-30 19:59:40','2015-12-30 20:25:03',0,25,0,2,2),
	(2,0,'OIU765',2,'2015-12-30 20:01:33','2015-12-30 20:23:00',0,21,0,2,2),
	(3,0,'IIQ924',3,'2015-12-30 20:01:59','2015-12-30 20:24:07',1,22,0,2,2),
	(4,1,'IJ87Y',5,'2015-12-30 20:02:21','2015-12-30 20:50:47',1,48,0,2,2),
	(5,0,'KCS976',6,'2015-12-30 20:02:36','2015-12-30 20:39:09',1,36,0,2,2),
	(6,0,'LOI987',7,'2015-12-30 20:02:48','2015-12-30 20:16:09',2,13,0,2,2),
	(8,0,'ILO876',7,'2015-12-30 20:22:18','2015-12-30 21:09:15',2,46,2000,2,2),
	(9,0,'IUT764',8,'2015-12-30 20:22:31','2015-12-30 20:40:23',2,17,2000,2,2),
	(10,1,'UY76T',10,'2015-12-30 20:22:41','2015-12-30 20:37:26',2,14,0,2,2),
	(11,0,'IOV345',11,'2015-12-30 16:22:52','2015-12-30 20:54:59',2,272,6800,2,2),
	(12,0,'XTR123',13,'2015-12-30 20:24:36','2015-12-30 20:45:58',2,21,2000,2,2),
	(13,1,'UYT12F',15,'2015-12-30 20:24:47','2015-12-30 20:41:51',2,17,1500,2,2),
	(14,0,'UHT564',16,'2015-12-30 20:40:19','2015-12-30 20:44:16',2,3,0,2,2),
...
VALUES
	...
	('nb_tarifasv_pg',6,45,'Tiempo Salida'),
	('nb_tarifasv_pg',6,46,'Tiempo_Salida'),
	('nb_tarifasv_pg',6,47,'false'),
	('nb_tarifasv_pg',6,48,'true'),
	('nb_tarifasv_pg',1,50,'nb_1_tipotarifa_fld={tarifa}&nb_1_tipo_vehi_fld={tipo}&nb_3_tipocobro_fld={cobro}'),
	('nb_tarifasv_pg',6,54,'center'),
	('nb_monitoreo_pg',10,45,'Estado'),
	('nb_monitoreo_pg',10,46,'estado'),
	('nb_monitoreo_pg',10,48,'true'),
	('nb_monitoreo_pg',10,54,'center');
...
VALUES
	...
	('nb_tarifasm_pg','NB_TARIFAS_TBL','nb_1_tipotarifa_fld','nb_1_tipotarifa_fld'),
	('nb_tarifasm_pg','NB_TARIFAS_TBL','nb_1_tipo_vehi_fld','nb_1_tipo_vehi_fld'),
	('nb_tarifasm_pg','NB_TARIFAS_TBL','nb_3_tipocobro_fld','nb_3_tipocobro_fld'),
	('nb_tarifasm_pg','NB_TARIFAS_TBL','nb_4_valor_fld','nb_4_valor_fld'),
	('nb_tarifasm_pg','NB_TARIFAS_TBL','nb_5_tiempoG_fld','nb_5_tiempoG_fld'),
	('nb_tarifasm_pg','NB_TARIFAS_TBL','nb_6_tiempoS_fld','nb_6_tiempoS_fld'),
	...
	('nb_usuarios_pg','NB_USUARIOSR_TBL','nb_3_placa_fld','nb_3_placa_fld'),
	('nb_usuarios_pg','NB_USUARIOSR_TBL','nb_4_placa_fld','nb_4_placa_fld'),
	('nb_usuarios_pg','NB_USUARIOSR_TBL','nb_nombre_fld','nb_nombre_fld'),
	('nb_usuarios_pg','NB_USUARIOSR_TBL','nb_numerodoc_fld','nb_numerodoc_fld'),
	('nb_usuarios_pg','NB_USUARIOSR_TBL','nb_tipodoc_fld','nb_tipodoc_fld');
...
VALUES
	...
	('nb_tarifas_pg','nb_3_tipocobro_fld',11,'true'),
	('nb_tarifas_pg','nb_1_tipotarifa_fld',11,'true'),
	('nb_tarifas_pg','nb_1_tipo_vehi_fld',11,'true'),
	('nb_tarifasm_pg','nb_6_tiempoS_fld',24,'Tiempo Salida (Min)'),
	('nb_tarifasm_pg','nb_6_tiempoS_fld',60,'{\"nb_1_tipotarifa_fldX\":[\"2\"]}'),
	('nb_tarifasm_pg','nb_6_tiempoS_fld',13,'string'),
	('nb_tarifasm_pg','nb_6_tiempoS_fld',2,'nb_1_tipotarifa_fldX'),
	('nb_tarifasm_pg','nb_5_tiempoG_fld',60,'{\"nb_1_tipotarifa_fldX\":[\"2\"]}'),
	('nb_tarifasm_pg','nb_5_tiempoG_fld',13,'string'),
	('nb_tarifasm_pg','nb_5_tiempoG_fld',24,'Tiempo Gratis (Min)'),
	('nb_tarifasm_pg','nb_5_tiempoG_fld',2,'nb_1_tipotarifa_fldX'),
	('nb_tarifasm_pg','nb_4_valor_fld',24,'Valor'),
	('nb_tarifasm_pg','nb_4_valor_fld',60,'{\"nb_1_tipotarifa_fldX\":[\"1\",\"2\"]}'),
	('nb_tarifasm_pg','nb_4_valor_fld',13,'string'),
	('nb_tarifasm_pg','nb_3_tipocobro_fld',59,'false'),
	('nb_tarifasm_pg','nb_4_valor_fld',2,'nb_1_tipotarifa_fldX'),
	...
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',24,'Tipo tarifa'),
	...
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',11,'true'),
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',13,'string'),
	...
	('nb_tarifasm_pg','nb_1_tipo_vehi_fldX',59,'false'),
	('nb_tarifasm_pg','nb_1_tipo_vehi_fldX',58,'Seleccione Tipo Vehiculo'),
	('nb_tarifasm_pg','nb_1_tipo_vehi_fldX',55,'../Events/ValoresCampo.php?campo=nb_1_tipo_vehi_fld'),
	('nb_tarifasm_pg','nb_1_tipo_vehi_fldX',32,'select'),
	('nb_tarifasm_pg','nb_1_tipo_vehi_fldX',24,'Tipo Vehiculo'),
	('nb_tarifasm_pg','nb_1_tipo_vehi_fldX',13,'string'),
	('nb_tarifasm_pg','nb_1_tipo_vehi_fldX',11,'true'),
	('nb_tarifasm_pg','nb_1_tipotarifa_fld',36,'true'),
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',29,'true'),
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',59,'false'),
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',58,'Seleccione tipo Tarifa'),
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',55,'../Events/ValoresCampo.php?campo=nb_1_tipotarifa_fld'),
	('nb_tarifasm_pg','nb_1_tipotarifa_fldX',32,'select'),
	...
	('nb_tarifasm_pg','nb_3_tipocobro_fldX',11,'true'),
	...
	('nb_control_pg','nb_1_tipo_vehi_fld',13,'string'),
	...
	('nb_usuarios_pg','nb_tipodoc_fld',13,'string'),
	...
	('nb_tarifasm_pg','nb_3_tipocobro_fldX',24,'Tipo Cobro'),
	('nb_tarifasm_pg','nb_3_tipocobro_fldX',13,'string'),
	...
	('nb_tarifasm_pg','nb_3_tipocobro_fldX',32,'select'),
	('nb_tarifasm_pg','nb_3_tipocobro_fldX',55,'../Events/ValoresCampo.php?campo=nb_3_tipocobro_fld'),
	('nb_tarifasm_pg','nb_3_tipocobro_fldX',58,'Seleccione Tipo Cobro'),
	...
	('nb_usuariosm_pg','nb_tipodoc_fldX',13,'string'),
	('nb_usuariosm_pg','nb_tipodoc_fldX',24,'Tipo de Documento'),
	('nb_usuariosm_pg','nb_tipodoc_fldX',32,'select'),
	('nb_usuariosm_pg','nb_tipodoc_fldX',55,'../Events/ValoresCampo.php?campo=nb_tipodoc_fld'),
	('nb_usuariosm_pg','nb_tipodoc_fldX',58,'Seleccione Tipo de Documento'),
	('nb_usuariosm_pg','nb_tipodoc_fldX',59,'false'),
	('nb_usuariosm_pg','nb_numerodoc_fldX',11,'true'),
	('nb_usuariosm_pg','nb_numerodoc_fldX',13,'string'),
	('nb_usuariosm_pg','nb_numerodoc_fldX',24,'Numero Documento'),
	('nb_usuariosm_pg','nb_numerodoc_fldX',29,'true'),
	('nb_usuariosm_pg','nb_tipodoc_fldX',29,'true'),
	('nb_usuariosm_pg','nb_tipodoc_fld',36,'true'),
	('nb_usuariosm_pg','nb_numerodoc_fld',36,'true'),
...
VALUES
	('home',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	...
	('nb_reporte_mensual_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_reporte_mensual_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_reporte_mensual_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_reporte_mensual_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_reporte_mensual_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_reporte_mensual_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	...
	('nb_reporte_diario_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	...
	('home',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('home',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	...
	('nb_password_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_password_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_usuarios_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_usuarios_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_usuarios_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_usuarios_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_usuarios_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_usuarios_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_usuarios_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_usuarios_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_usuarios_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_usuarios_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_usuarios_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_usuarios_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_password_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_password_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_password_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	...
	('ayuda',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('ayuda',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('ayuda',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('ayuda',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('ayuda',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('ayuda',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('ayuda',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('ayuda',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('ayuda',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('ayuda',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('ayuda',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('ayuda',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('ayuda',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('ayuda',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('ayuda',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('ayuda',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('ayuda',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('ayuda',1,0,1,'Home','home','fa fa-home','N'),
	('ayuda',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_reporte_diario_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_reporte_diario_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_reporte_diario_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_reporte_diario_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_reporte_diario_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_reporte_diario_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_reporte_diario_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_reporte_diario_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_reporte_diario_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_reporte_diario_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_reporte_diario_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_reporte_diario_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_reporte_diario_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_reporte_diario_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_reporte_diario_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_reporte_mensual_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_reporte_mensual_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_reporte_mensual_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_reporte_mensual_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_reporte_mensual_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_reporte_mensual_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_reporte_mensual_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_reporte_mensual_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_reporte_mensual_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_reporte_mensual_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_reporte_mensual_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_reporte_mensual_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_reporte_mensual_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_reporte_mensual_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_reporte_mensual_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_reporte_mensual_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_password_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_password_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_password_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_password_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_password_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_password_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_password_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_password_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_password_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_password_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_password_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_password_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_usuarios_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_usuarios_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_usuarios_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_usuarios_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_usuarios_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_usuarios_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_usuarios_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_usuarios_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_usuarios_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_usuarios_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_monitoreo_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_monitoreo_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_monitoreo_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_monitoreo_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_monitoreo_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_monitoreo_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_monitoreo_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_monitoreo_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_monitoreo_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_monitoreo_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_monitoreo_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_monitoreo_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_monitoreo_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	...
	('nb_monitoreo_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_monitoreo_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	...
	('nb_control_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_control_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_monitoreo_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_monitoreo_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_control_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_control_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_control_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_tarifasv_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_control_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_control_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_control_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_control_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_control_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_control_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_recaudo_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_recaudo_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_control_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_control_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_control_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_control_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_control_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_control_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_control_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_control_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_control_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_control_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_tarifas_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_tarifas_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_control_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_tarifas_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_tarifas_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_tarifas_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_tarifas_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_tarifas_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_tarifas_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_tarifas_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_tarifas_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_tarifas_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_tarifas_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_tarifas_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_tarifas_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_tarifas_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_tarifas_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_tarifas_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_tarifas_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_tarifas_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_tarifas_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_tarifas_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_recaudo_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_recaudo_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_tarifas_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_recaudo_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_recaudo_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_recaudo_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_recaudo_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_recaudo_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_recaudo_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_recaudo_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_recaudo_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_recaudo_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_recaudo_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_recaudo_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_recaudo_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_recaudo_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_recaudo_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_recaudo_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_recaudo_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_recaudo_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_recaudo_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_tarifasv_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_tarifasv_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_tarifasv_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_tarifasv_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_tarifasv_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_tarifasv_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_tarifasv_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_tarifasv_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_tarifasv_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_tarifasv_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_tarifasv_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_tarifasv_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_tarifasv_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_tarifasv_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_tarifasv_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_tarifasv_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_tarifasv_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_tarifasv_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_tarifasv_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_usuariosv_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_tarifasv_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_tarifasv_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_usuariosv_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_usuariosv_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_usuariosv_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_usuariosv_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_usuariosv_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_usuariosv_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_usuariosv_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_usuariosv_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_usuariosv_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_usuariosv_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_usuariosv_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_usuariosv_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_usuariosv_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_usuariosv_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_usuariosv_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_usuariosv_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_usuariosv_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_usuariosv_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_usuariosv_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_usuariosv_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_users_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_usuariosv_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_users_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_users_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_users_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_users_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_users_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_users_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_users_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_users_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_users_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_users_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_users_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_users_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_users_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_users_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_users_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_users_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_users_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_users_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_users_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_users_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_users_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_loginv_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_loginv_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_loginv_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_loginv_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_loginv_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_loginv_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_loginv_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_loginv_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_loginv_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_loginv_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_loginv_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_loginv_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_loginv_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_loginv_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_loginv_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_loginv_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_loginv_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_loginv_pg',3,2,1,'Control','nb_control_pg','fa fa-check-square','N'),
	('nb_loginv_pg',4,2,2,'Recaudo','nb_recaudo_pg','fa fa-money','N'),
	('nb_loginv_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
	('nb_loginv_pg',2,0,2,'Vehiculos','nb_monitoreo_pg','fa fa-car','N'),
	('nb_reporte_total_pg',22,0,8,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_loginv_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_reporte_total_pg',21,19,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_reporte_total_pg',20,19,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_reporte_total_pg',19,0,7,'Configuracion','home','fa fa-cog','N'),
	('nb_reporte_total_pg',18,15,3,'Reporte Mensual Cobros','nb_reporte_mensual_pg','fa fa-calculator','N'),
	('nb_reporte_total_pg',16,15,1,'Reporte Total','nb_reporte_total_pg','fa fa-table','N'),
	('nb_reporte_total_pg',17,15,2,'Reporte Diario Cobros','nb_reporte_diario_pg','fa fa-money','N'),
	('nb_reporte_total_pg',14,12,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_reporte_total_pg',15,0,6,'Reportes','nb_reporte_diario_pg','fa fa-desktop','N'),
	('nb_reporte_total_pg',12,0,5,'Usuarios Software','construccion','fa fa-users','N'),
	('nb_reporte_total_pg',13,12,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_reporte_total_pg',10,9,1,'Ingreso Usuarios','nb_usuarios_pg','fa fa-plus','N'),
	('nb_reporte_total_pg',11,9,2,'Consulta Usuarios','nb_usuariosv_pg','fa fa-search','N'),
	('nb_reporte_total_pg',8,6,2,'Consulta Tarifas','nb_tarifasv_pg','fa fa-search','N'),
	('nb_reporte_total_pg',9,0,4,'Usuarios Parqueadero','construccion','fa fa-group','N'),
	('nb_reporte_total_pg',6,0,3,'Tarificacion','construccion','fa fa-dollar','N'),
	('nb_reporte_total_pg',7,6,1,'Ingreso Tarifas','nb_tarifas_pg','fa fa-plus','N'),
	('nb_reporte_total_pg',5,2,3,'Monitoreo','nb_monitoreo_pg','fa fa-table','N'),
...
VALUES
	...
	('nb_control_pg','wizard','true','../Events/','nabuControl','0','post',NULL),
	('nb_controlv_pg','form','true',NULL,NULL,NULL,'post',NULL),
...
VALUES
	(0,1037595925,1,2015,12,0),
	(0,123456,1,2015,12,0),
	(0,9876543,1,2015,12,0),
	(0,111111,1,2015,12,0);
...
VALUES
	('NB_USUARIOSR_TBL','nb_2_placa_fld','string',255,'N','',''),
	...
	('NB_TARIFAS_TBL','nb_1_tipo_vehi_fld','number',2,'Y','',''),
	('NB_TARIFAS_TBL','nb_1_tipotarifa_fld','number',2,'Y','',''),
...
CREATE TABLE `nb_tarifas_tbl` (
  ...
  `nb_4_valor_fld` int(14) DEFAULT '0',
  `nb_5_tiempoG_fld` int(2) DEFAULT '0',
  `nb_6_tiempoS_fld` int(2) DEFAULT '0',
...
CREATE TABLE `nb_tarifas_vw` (
   ...
   `Valor` VARCHAR(52) NULL DEFAULT NULL,
   `Tiempo_Gratis` INT(2) NULL DEFAULT '0',
   `Tiempo_Salida` INT(2) NULL DEFAULT '0'
) ENGINE=MyISAM;
...
VALUES
	...
	(1,'nb_usuariosm_pg','nb_tipodoc_fldX',1,1),
...
VALUES
	(1,'nb_recaudo_pg','Registro','Registro Pagos'),
...
VALUES
	...
	(9,'nb_password_pg',NULL,NULL,'false');
