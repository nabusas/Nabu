...
select  b.nb_id_page_fld,nb_sec_fld,nb_parent_fld,nb_id_menu_fld,nb_descr_men_fld,nb_link_fld,nb_image_fld,nb_target_fld
from 	nb_navigation_tbl a , nb_pages_tbl b
where	a.nb_id_page_fld='home'
and		b.nb_id_page_fld<>'home'
order by 1,2
