...
VALUES
	...
	('nb_inventario_v_pg',44,'nb_inventario_vw'),
	...
	('nb_productos_v_pg',44,'nb_productos_vw'),
	...
	('nb_vendedores_v_pg',37,'Informacion Vendedores'),
	('nb_vendedores_v_pg',38,'true'),
	('nb_vendedores_v_pg',39,'44'),
	('nb_vendedores_v_pg',40,'true'),
	('nb_vendedores_v_pg',41,'true'),
	('nb_vendedores_v_pg',43,'350'),
...
VALUES
	...
	('nb_clientes_v_pg',1,45,'Id'),
	('nb_clientes_v_pg',1,46,'Id'),
	('nb_clientes_v_pg',1,47,'true'),
	('nb_clientes_v_pg',1,48,'true'),
	('nb_clientes_v_pg',1,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',1,54,'center'),
	('nb_vendedores_v_pg',1,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',1,48,'true'),
	('nb_vendedores_v_pg',1,47,'true'),
	('nb_vendedores_v_pg',1,46,'Id'),
	('nb_vendedores_v_pg',1,45,'Id'),
	('nb_proveedores_v_pg',1,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',1,48,'true'),
	('nb_proveedores_v_pg',1,47,'true'),
	('nb_proveedores_v_pg',1,46,'Id'),
	('nb_proveedores_v_pg',1,45,'Id'),
	('nb_productos_v_pg',1,50,'nb_prod_1_fld={Id}'),
	('nb_productos_v_pg',1,48,'true'),
	...
	('nb_inventario_v_pg',4,47,'true'),
	('nb_inventario_v_pg',4,46,'Fecha'),
	('nb_inventario_v_pg',4,45,'Fecha'),
	('nb_inventario_v_pg',3,54,'center'),
	('nb_inventario_v_pg',3,50,'nb_inve_1_fld={Id}'),
	('nb_inventario_v_pg',3,48,'true'),
	('nb_inventario_v_pg',3,47,'true'),
	('nb_inventario_v_pg',3,46,'Cantidad'),
	('nb_inventario_v_pg',3,45,'Cantidad'),
	('nb_inventario_v_pg',2,54,'center'),
	('nb_inventario_v_pg',2,50,'nb_inve_1_fld={Id}'),
	('nb_inventario_v_pg',2,48,'true'),
	('nb_inventario_v_pg',2,47,'true'),
	('nb_inventario_v_pg',2,46,'Producto'),
	('nb_inventario_v_pg',2,45,'Producto'),
	('nb_inventario_v_pg',1,54,'center'),
	('nb_inventario_v_pg',1,50,'nb_inve_1_fld={Id}'),
	('nb_inventario_v_pg',1,48,'true'),
	('nb_inventario_v_pg',1,47,'true'),
	('nb_inventario_v_pg',1,46,'Id'),
	('nb_inventario_v_pg',1,45,'Id'),
	('nb_clientes_v_pg',2,45,'Tipo Documento'),
	('nb_clientes_v_pg',2,46,'Tipo_Documento'),
	('nb_clientes_v_pg',2,47,'true'),
	('nb_clientes_v_pg',2,48,'true'),
	('nb_clientes_v_pg',2,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',2,54,'center'),
	('nb_clientes_v_pg',3,45,'Documento'),
	('nb_clientes_v_pg',3,46,'Documento'),
	('nb_clientes_v_pg',3,47,'true'),
	('nb_clientes_v_pg',3,48,'true'),
	('nb_clientes_v_pg',3,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',3,54,'center'),
	('nb_clientes_v_pg',4,45,'Nombre/Razon Social'),
	('nb_clientes_v_pg',4,46,'Nombre'),
	('nb_clientes_v_pg',4,47,'true'),
	('nb_clientes_v_pg',4,48,'true'),
	('nb_clientes_v_pg',4,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',4,54,'center'),
	('nb_clientes_v_pg',5,45,'Direccion'),
	('nb_clientes_v_pg',5,46,'Direccion'),
	('nb_clientes_v_pg',5,47,'true'),
	('nb_clientes_v_pg',5,48,'true'),
	('nb_clientes_v_pg',5,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',5,54,'center'),
	('nb_clientes_v_pg',6,45,'Telefono'),
	('nb_clientes_v_pg',6,46,'Telefono'),
	('nb_clientes_v_pg',6,47,'true'),
	('nb_clientes_v_pg',6,48,'true'),
	('nb_clientes_v_pg',6,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',6,54,'center'),
	('nb_clientes_v_pg',7,45,'Email'),
	('nb_clientes_v_pg',7,46,'Email'),
	('nb_clientes_v_pg',7,47,'true'),
	('nb_clientes_v_pg',7,48,'true'),
	('nb_clientes_v_pg',7,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',7,54,'center'),
	('nb_clientes_v_pg',8,45,'Estado'),
	('nb_clientes_v_pg',8,46,'Estado'),
	('nb_clientes_v_pg',8,47,'true'),
	('nb_clientes_v_pg',8,48,'true'),
	('nb_clientes_v_pg',8,50,'nb_clie_1_fld={Id}'),
	('nb_clientes_v_pg',8,54,'center'),
	('nb_vendedores_v_pg',1,54,'center'),
	('nb_vendedores_v_pg',2,45,'Tipo Documento'),
	('nb_vendedores_v_pg',2,46,'Tipo_Documento'),
	('nb_vendedores_v_pg',2,47,'true'),
	('nb_vendedores_v_pg',2,48,'true'),
	('nb_vendedores_v_pg',2,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',2,54,'center'),
	('nb_vendedores_v_pg',3,45,'Documento'),
	('nb_vendedores_v_pg',3,46,'Documento'),
	('nb_vendedores_v_pg',3,47,'true'),
	('nb_vendedores_v_pg',3,48,'true'),
	('nb_vendedores_v_pg',3,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',3,54,'center'),
	('nb_vendedores_v_pg',4,45,'Nombre/Razon Social'),
	('nb_vendedores_v_pg',4,46,'Nombre'),
	('nb_vendedores_v_pg',4,47,'true'),
	('nb_vendedores_v_pg',4,48,'true'),
	('nb_vendedores_v_pg',4,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',4,54,'center'),
	('nb_vendedores_v_pg',5,45,'Direccion'),
	('nb_vendedores_v_pg',5,46,'Direccion'),
	('nb_vendedores_v_pg',5,47,'true'),
	('nb_vendedores_v_pg',5,48,'true'),
	('nb_vendedores_v_pg',5,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',5,54,'center'),
	('nb_vendedores_v_pg',6,45,'Telefono'),
	('nb_vendedores_v_pg',6,46,'Telefono'),
	('nb_vendedores_v_pg',6,47,'true'),
	('nb_vendedores_v_pg',6,48,'true'),
	('nb_vendedores_v_pg',6,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',6,54,'center'),
	('nb_vendedores_v_pg',7,45,'Email'),
	('nb_vendedores_v_pg',7,46,'Email'),
	('nb_vendedores_v_pg',7,47,'true'),
	('nb_vendedores_v_pg',7,48,'true'),
	('nb_vendedores_v_pg',7,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',7,54,'center'),
	('nb_vendedores_v_pg',8,45,'Estado'),
	('nb_vendedores_v_pg',8,46,'Estado'),
	('nb_vendedores_v_pg',8,47,'true'),
	('nb_vendedores_v_pg',8,48,'true'),
	('nb_vendedores_v_pg',8,50,'nb_vend_1_fld={Id}'),
	('nb_vendedores_v_pg',8,54,'center'),
	('nb_proveedores_v_pg',1,54,'center'),
	('nb_proveedores_v_pg',2,45,'Tipo Documento'),
	('nb_proveedores_v_pg',2,46,'Tipo_Documento'),
	('nb_proveedores_v_pg',2,47,'true'),
	('nb_proveedores_v_pg',2,48,'true'),
	('nb_proveedores_v_pg',2,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',2,54,'center'),
	('nb_proveedores_v_pg',3,45,'Documento'),
	('nb_proveedores_v_pg',3,46,'Documento'),
	('nb_proveedores_v_pg',3,47,'true'),
	('nb_proveedores_v_pg',3,48,'true'),
	('nb_proveedores_v_pg',3,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',3,54,'center'),
	('nb_proveedores_v_pg',4,45,'Nombre/Razon Social'),
	('nb_proveedores_v_pg',4,46,'Nombre'),
	('nb_proveedores_v_pg',4,47,'true'),
	('nb_proveedores_v_pg',4,48,'true'),
	('nb_proveedores_v_pg',4,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',4,54,'center'),
	('nb_proveedores_v_pg',5,45,'Direccion'),
	('nb_proveedores_v_pg',5,46,'Direccion'),
	('nb_proveedores_v_pg',5,47,'true'),
	('nb_proveedores_v_pg',5,48,'true'),
	('nb_proveedores_v_pg',5,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',5,54,'center'),
	('nb_proveedores_v_pg',6,45,'Telefono'),
	('nb_proveedores_v_pg',6,46,'Telefono'),
	('nb_proveedores_v_pg',6,47,'true'),
	('nb_proveedores_v_pg',6,48,'true'),
	('nb_proveedores_v_pg',6,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',6,54,'center'),
	('nb_proveedores_v_pg',7,45,'Email'),
	('nb_proveedores_v_pg',7,46,'Email'),
	('nb_proveedores_v_pg',7,47,'true'),
	('nb_proveedores_v_pg',7,48,'true'),
	('nb_proveedores_v_pg',7,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',7,54,'center'),
	('nb_proveedores_v_pg',8,45,'Estado'),
	('nb_proveedores_v_pg',8,46,'Estado'),
	('nb_proveedores_v_pg',8,47,'true'),
	('nb_proveedores_v_pg',8,48,'true'),
	('nb_proveedores_v_pg',8,50,'nb_prov_1_fld={Id}'),
	('nb_proveedores_v_pg',8,54,'center'),
	('nb_productos_v_pg',1,54,'center'),
	('nb_productos_v_pg',2,45,'Descripcion'),
	('nb_productos_v_pg',2,46,'Descripcion'),
	('nb_productos_v_pg',2,47,'true'),
	('nb_productos_v_pg',2,48,'true'),
	('nb_productos_v_pg',2,50,'nb_prod_1_fld={Id}'),
	('nb_productos_v_pg',2,54,'center'),
	('nb_productos_v_pg',3,45,'Marca'),
	('nb_productos_v_pg',3,46,'Marca'),
	('nb_productos_v_pg',3,47,'true'),
	('nb_productos_v_pg',3,48,'true'),
	('nb_productos_v_pg',3,50,'nb_prod_1_fld={Id}'),
	('nb_productos_v_pg',3,54,'center'),
	('nb_productos_v_pg',4,45,'Modelo'),
	('nb_productos_v_pg',4,46,'Modelo'),
	('nb_productos_v_pg',4,47,'true'),
	('nb_productos_v_pg',4,48,'true'),
	('nb_productos_v_pg',4,50,'nb_prod_1_fld={Id}'),
	('nb_productos_v_pg',4,54,'center'),
	('nb_productos_v_pg',5,45,'UOM'),
	('nb_productos_v_pg',5,46,'UOM'),
	('nb_productos_v_pg',5,47,'true'),
	('nb_productos_v_pg',5,48,'true'),
	('nb_productos_v_pg',5,50,'nb_prod_1_fld={Id}'),
	('nb_productos_v_pg',5,54,'center'),
	('nb_productos_v_pg',6,45,'Precio'),
	('nb_productos_v_pg',6,46,'Precio'),
	('nb_productos_v_pg',6,47,'true'),
	('nb_productos_v_pg',6,48,'true'),
	('nb_productos_v_pg',6,50,'nb_prod_1_fld={Id}'),
	('nb_productos_v_pg',6,54,'center'),
	('nb_productos_v_pg',7,45,'IVA'),
	('nb_productos_v_pg',7,46,'Iva'),
...
VALUES
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_10_fld','nb_clie_10_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_11_fld','nb_clie_11_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_12_fld','nb_clie_12_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_13_fld','nb_clie_13_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_14_fld','nb_clie_14_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_15_fld','nb_clie_15_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_16_fld','nb_clie_16_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_17_fld','nb_clie_17_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_18_fld','nb_clie_18_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_19_fld','nb_clie_19_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_1_fld','nb_clie_1_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_20_fld','nb_clie_20_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_2_fld','nb_clie_2_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_3_fld','nb_clie_3_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_4_fld','nb_clie_4_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_5_fld','nb_clie_5_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_6_fld','nb_clie_6_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_7_fld','nb_clie_7_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_8_fld','nb_clie_8_fld'),
	('nb_clientes_m_pg','nb_clientes_tbl','nb_clie_9_fld','nb_clie_9_fld'),
	...
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_10_fld','nb_inve_10_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_11_fld','nb_inve_11_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_12_fld','nb_inve_12_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_13_fld','nb_inve_13_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_14_fld','nb_inve_14_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_15_fld','nb_inve_15_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_16_fld','nb_inve_16_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_17_fld','nb_inve_17_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_18_fld','nb_inve_18_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_19_fld','nb_inve_19_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_1_fld','nb_inve_1_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_20_fld','nb_inve_20_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_2_fld','nb_inve_2_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_3_fld','nb_inve_3_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_4_fld','nb_inve_4_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_5_fld','nb_inve_5_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_6_fld','nb_inve_6_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_7_fld','nb_inve_7_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_8_fld','nb_inve_8_fld'),
	('nb_inventario_m_pg','nb_inventario_tbl','nb_inve_9_fld','nb_inve_9_fld'),
	...
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_10_fld','nb_prod_10_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_11_fld','nb_prod_11_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_12_fld','nb_prod_12_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_13_fld','nb_prod_13_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_14_fld','nb_prod_14_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_15_fld','nb_prod_15_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_16_fld','nb_prod_16_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_17_fld','nb_prod_17_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_18_fld','nb_prod_18_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_19_fld','nb_prod_19_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_1_fld','nb_prod_1_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_20_fld','nb_prod_20_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_2_fld','nb_prod_2_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_3_fld','nb_prod_3_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_4_fld','nb_prod_4_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_5_fld','nb_prod_5_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_6_fld','nb_prod_6_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_7_fld','nb_prod_7_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_8_fld','nb_prod_8_fld'),
	('nb_productos_m_pg','nb_productos_tbl','nb_prod_9_fld','nb_prod_9_fld'),
	...
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_10_fld','nb_prov_10_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_11_fld','nb_prov_11_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_12_fld','nb_prov_12_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_13_fld','nb_prov_13_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_14_fld','nb_prov_14_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_15_fld','nb_prov_15_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_16_fld','nb_prov_16_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_17_fld','nb_prov_17_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_18_fld','nb_prov_18_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_19_fld','nb_prov_19_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_1_fld','nb_prov_1_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_20_fld','nb_prov_20_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_2_fld','nb_prov_2_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_3_fld','nb_prov_3_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_4_fld','nb_prov_4_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_5_fld','nb_prov_5_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_6_fld','nb_prov_6_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_7_fld','nb_prov_7_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_8_fld','nb_prov_8_fld'),
	('nb_proveedores_m_pg','nb_proveedores_tbl','nb_prov_9_fld','nb_prov_9_fld'),
	...
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_10_fld','nb_vend_10_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_11_fld','nb_vend_11_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_12_fld','nb_vend_12_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_13_fld','nb_vend_13_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_14_fld','nb_vend_14_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_15_fld','nb_vend_15_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_16_fld','nb_vend_16_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_17_fld','nb_vend_17_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_18_fld','nb_vend_18_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_19_fld','nb_vend_19_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_1_fld','nb_vend_1_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_20_fld','nb_vend_20_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_2_fld','nb_vend_2_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_3_fld','nb_vend_3_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_4_fld','nb_vend_4_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_5_fld','nb_vend_5_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_6_fld','nb_vend_6_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_7_fld','nb_vend_7_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_8_fld','nb_vend_8_fld'),
	('nb_vendedores_m_pg','nb_vendedores_tbl','nb_vend_9_fld','nb_vend_9_fld'),
...
VALUES
	...
	('nb_facturacion_pg','nb_fact_11_fld',55,'../Events/ValoresCampo.php?campo=nb_tipofact_fld'),
	('nb_facturacion_pg','nb_fact_11_fld',58,'Seleccione Tipo'),
	('nb_facturacion_pg','nb_fact_11_fld',59,'false'),
	('nb_facturacion_pg','nb_fact_12_fld',11,'false'),
	('nb_facturacion_pg','nb_fact_12_fld',13,'string'),
	('nb_facturacion_pg','nb_fact_12_fld',24,'Observacion'),
	('nb_facturacion_pg','nb_fact_12_fld',32,'textarea'),
	('nb_facturacion_pg','nb_fact_12_fld',36,'false'),
	...
	('nb_facturacion_pg','nb_fact_8_fld',56,'DD/MM/YYYY'),
	...
	('nb_inventario_pg','nb_inve_4_fld',6,'date'),
	('nb_inventario_pg','nb_inve_4_fld',11,'true'),
	('nb_inventario_pg','nb_inve_4_fld',13,'string'),
	('nb_inventario_pg','nb_inve_4_fld',24,'Fecha Ingreso '),
	('nb_inventario_pg','nb_inve_4_fld',36,'false'),
	...
	('nb_proveedores_pg','nb_prov_1_fld',24,'Id proveedor'),
	('nb_proveedores_pg','nb_prov_1_fld',36,'true'),
	...
	('nb_proveedores_pg','nb_prov_2_fld',11,'true'),
	('nb_proveedores_pg','nb_prov_2_fld',13,'string'),
	('nb_proveedores_pg','nb_prov_2_fld',24,'Tipo Documento'),
	('nb_proveedores_pg','nb_prov_2_fld',32,'select'),
	('nb_proveedores_pg','nb_prov_2_fld',36,'false'),
	('nb_proveedores_pg','nb_prov_2_fld',55,'../Events/ValoresCampo.php?campo=nb_tipodoc_fld'),
	('nb_proveedores_pg','nb_prov_2_fld',58,'Seleccione Tipo Documento'),
	('nb_proveedores_pg','nb_prov_2_fld',59,'false'),
	('nb_proveedores_pg','nb_prov_3_fld',11,'true'),
	('nb_proveedores_pg','nb_prov_3_fld',13,'string'),
	('nb_proveedores_pg','nb_prov_3_fld',24,'# Documento'),
	('nb_proveedores_pg','nb_prov_3_fld',32,'number'),
	('nb_proveedores_pg','nb_prov_3_fld',36,'false'),
	('nb_proveedores_pg','nb_prov_4_fld',11,'true'),
	('nb_proveedores_pg','nb_prov_4_fld',13,'string'),
	('nb_proveedores_pg','nb_prov_4_fld',24,'Nombre o Razon Social'),
	...
	('nb_proveedores_pg','nb_prov_5_fld',24,'Direccion'),
	...
	('nb_proveedores_pg','nb_prov_6_fld',24,'Telefono'),
	...
	('nb_proveedores_pg','nb_prov_7_fld',24,'Email'),
	('nb_proveedores_pg','nb_prov_7_fld',32,'email'),
	...
	('nb_proveedores_pg','nb_prov_8_fld',24,'Estado'),
	('nb_proveedores_pg','nb_prov_8_fld',32,'select'),
	('nb_proveedores_pg','nb_prov_8_fld',36,'false'),
	('nb_proveedores_pg','nb_prov_8_fld',55,'../Events/ValoresCampo.php?campo=nb_estado_fld'),
	('nb_proveedores_pg','nb_prov_8_fld',58,'Seleccione Estado'),
	('nb_proveedores_pg','nb_prov_8_fld',59,'false'),
	('nb_proveedores_pg','nb_prov_9_fld',11,'false'),
	('nb_proveedores_pg','nb_prov_9_fld',13,'string'),
	('nb_proveedores_pg','nb_prov_9_fld',24,'Observaciones'),
	...
	('nb_vendedores_pg','nb_vend_1_fld',24,'Id Vendedor'),
	('nb_vendedores_pg','nb_vend_1_fld',32,'number'),
	('nb_vendedores_pg','nb_vend_1_fld',36,'true'),
	...
	('nb_vendedores_pg','nb_vend_2_fld',11,'true'),
	('nb_vendedores_pg','nb_vend_2_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_2_fld',24,'Tipo Documento'),
	('nb_vendedores_pg','nb_vend_2_fld',32,'select'),
	('nb_vendedores_pg','nb_vend_2_fld',36,'false'),
	('nb_vendedores_pg','nb_vend_2_fld',55,'../Events/ValoresCampo.php?campo=nb_tipodoc_fld'),
	('nb_vendedores_pg','nb_vend_2_fld',58,'Seleccione Tipo Documento'),
	('nb_vendedores_pg','nb_vend_2_fld',59,'false'),
	('nb_vendedores_pg','nb_vend_3_fld',11,'true'),
	('nb_vendedores_pg','nb_vend_3_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_3_fld',24,'# Documento'),
	('nb_vendedores_pg','nb_vend_3_fld',32,'number'),
	('nb_vendedores_pg','nb_vend_3_fld',36,'false'),
	('nb_vendedores_pg','nb_vend_4_fld',11,'true'),
	('nb_vendedores_pg','nb_vend_4_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_4_fld',24,'Nombre y Apellido'),
	('nb_vendedores_pg','nb_vend_4_fld',36,'false'),
	('nb_vendedores_pg','nb_vend_5_fld',11,'false'),
	('nb_vendedores_pg','nb_vend_5_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_5_fld',24,'Direccion'),
	('nb_vendedores_pg','nb_vend_5_fld',36,'false'),
	('nb_vendedores_pg','nb_vend_6_fld',11,'false'),
	('nb_vendedores_pg','nb_vend_6_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_6_fld',24,'Telefono'),
	('nb_vendedores_pg','nb_vend_6_fld',36,'false'),
	('nb_vendedores_pg','nb_vend_7_fld',11,'false'),
	('nb_vendedores_pg','nb_vend_7_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_7_fld',24,'Email'),
	('nb_vendedores_pg','nb_vend_7_fld',32,'email'),
	('nb_vendedores_pg','nb_vend_7_fld',36,'false'),
	('nb_vendedores_pg','nb_vend_8_fld',11,'false'),
	('nb_vendedores_pg','nb_vend_8_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_8_fld',24,'Estado'),
	('nb_vendedores_pg','nb_vend_8_fld',32,'select'),
	('nb_vendedores_pg','nb_vend_8_fld',36,'false'),
	('nb_vendedores_pg','nb_vend_8_fld',55,'../Events/ValoresCampo.php?campo=nb_estado_fld'),
	('nb_vendedores_pg','nb_vend_8_fld',58,'Seleccione estado'),
	('nb_vendedores_pg','nb_vend_8_fld',59,'false'),
	('nb_vendedores_pg','nb_vend_9_fld',11,'false'),
	('nb_vendedores_pg','nb_vend_9_fld',13,'string'),
	('nb_vendedores_pg','nb_vend_9_fld',24,'Observaciones'),
	('nb_vendedores_pg','nb_vend_9_fld',32,'textarea'),
	('nb_vendedores_pg','nb_vend_9_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_10_fld',6,'email'),
	('nb_clientes_m_pg','nb_clie_10_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_10_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_10_fld',24,'Email'),
	('nb_clientes_m_pg','nb_clie_10_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_11_fld',11,'true'),
	('nb_clientes_m_pg','nb_clie_11_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_11_fld',24,'Estado'),
	('nb_clientes_m_pg','nb_clie_11_fld',32,'select'),
	('nb_clientes_m_pg','nb_clie_11_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_11_fld',55,'../Events/ValoresCampo.php?campo=nb_estado_fld'),
	('nb_clientes_m_pg','nb_clie_11_fld',58,'Seleccione Estado Cliente'),
	('nb_clientes_m_pg','nb_clie_11_fld',59,'false'),
	('nb_clientes_m_pg','nb_clie_12_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_12_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_12_fld',24,'Observaciones'),
	('nb_clientes_m_pg','nb_clie_12_fld',32,'textarea'),
	('nb_clientes_m_pg','nb_clie_12_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_13_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_13_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_13_fld',24,'Campo 13'),
	('nb_clientes_m_pg','nb_clie_13_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_14_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_14_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_14_fld',24,'Campo 14'),
	('nb_clientes_m_pg','nb_clie_14_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_15_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_15_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_15_fld',24,'Campo 15'),
	('nb_clientes_m_pg','nb_clie_15_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_16_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_16_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_16_fld',24,'Campo 16'),
	('nb_clientes_m_pg','nb_clie_16_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_17_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_17_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_17_fld',24,'Campo 17'),
	('nb_clientes_m_pg','nb_clie_17_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_18_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_18_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_18_fld',24,'Campo 18'),
	('nb_clientes_m_pg','nb_clie_18_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_19_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_19_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_19_fld',24,'Campo 19'),
	('nb_clientes_m_pg','nb_clie_19_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_1_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_1_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_1_fld',24,'Id Cliente'),
	('nb_clientes_m_pg','nb_clie_1_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_20_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_20_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_20_fld',24,'Campo 20'),
	('nb_clientes_m_pg','nb_clie_20_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_2_fld',11,'true'),
	('nb_clientes_m_pg','nb_clie_2_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_2_fld',24,'Tipo Documento'),
	('nb_clientes_m_pg','nb_clie_2_fld',32,'select'),
	('nb_clientes_m_pg','nb_clie_2_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_2_fld',55,'../Events/ValoresCampo.php?campo=nb_tipodoc_fld'),
	('nb_clientes_m_pg','nb_clie_2_fld',58,'Seleccione Tipo Documento'),
	('nb_clientes_m_pg','nb_clie_2_fld',59,'false'),
	('nb_clientes_m_pg','nb_clie_3_fld',11,'true'),
	('nb_clientes_m_pg','nb_clie_3_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_3_fld',24,'# Documento'),
	('nb_clientes_m_pg','nb_clie_3_fld',32,'number'),
	('nb_clientes_m_pg','nb_clie_3_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_4_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_4_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_4_fld',24,'Nombre'),
	('nb_clientes_m_pg','nb_clie_4_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_5_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_5_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_5_fld',24,'Apellido'),
	('nb_clientes_m_pg','nb_clie_5_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_6_fld',11,'true'),
	('nb_clientes_m_pg','nb_clie_6_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_6_fld',24,'Nombre o Razon Social'),
	('nb_clientes_m_pg','nb_clie_6_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_7_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_7_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_7_fld',24,'Ciudad'),
	('nb_clientes_m_pg','nb_clie_7_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_8_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_8_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_8_fld',24,'Direccion'),
	('nb_clientes_m_pg','nb_clie_8_fld',36,'false'),
	('nb_clientes_m_pg','nb_clie_9_fld',11,'false'),
	('nb_clientes_m_pg','nb_clie_9_fld',13,'string'),
	('nb_clientes_m_pg','nb_clie_9_fld',24,'Telefono'),
	('nb_clientes_m_pg','nb_clie_9_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_10_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_10_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_10_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_10_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_11_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_11_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_11_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_11_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_12_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_12_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_12_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_12_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_13_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_13_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_13_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_13_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_14_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_14_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_14_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_14_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_15_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_15_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_15_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_15_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_16_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_16_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_16_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_16_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_17_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_17_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_17_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_17_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_18_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_18_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_18_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_18_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_19_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_19_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_19_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_19_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_1_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_1_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_1_fld',24,'Id Vendedor'),
	('nb_vendedores_m_pg','nb_vend_1_fld',32,'number'),
	('nb_vendedores_m_pg','nb_vend_1_fld',36,'true'),
	('nb_vendedores_m_pg','nb_vend_20_fld',11,'campo 18'),
	('nb_vendedores_m_pg','nb_vend_20_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_20_fld',24,'campo'),
	('nb_vendedores_m_pg','nb_vend_20_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_2_fld',11,'true'),
	('nb_vendedores_m_pg','nb_vend_2_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_2_fld',24,'Tipo Documento'),
	('nb_vendedores_m_pg','nb_vend_2_fld',32,'select'),
	('nb_vendedores_m_pg','nb_vend_2_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_2_fld',55,'../Events/ValoresCampo.php?campo=nb_tipodoc_fld'),
	('nb_vendedores_m_pg','nb_vend_2_fld',58,'Seleccione Tipo Documento'),
	('nb_vendedores_m_pg','nb_vend_2_fld',59,'false'),
	('nb_vendedores_m_pg','nb_vend_3_fld',11,'true'),
	('nb_vendedores_m_pg','nb_vend_3_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_3_fld',24,'# Documento'),
	('nb_vendedores_m_pg','nb_vend_3_fld',32,'number'),
	('nb_vendedores_m_pg','nb_vend_3_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_4_fld',11,'true'),
	('nb_vendedores_m_pg','nb_vend_4_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_4_fld',24,'Nombre y Apellido'),
	('nb_vendedores_m_pg','nb_vend_4_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_5_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_5_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_5_fld',24,'Direccion'),
	('nb_vendedores_m_pg','nb_vend_5_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_6_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_6_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_6_fld',24,'Telefono'),
	('nb_vendedores_m_pg','nb_vend_6_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_7_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_7_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_7_fld',24,'Email'),
	('nb_vendedores_m_pg','nb_vend_7_fld',32,'email'),
	('nb_vendedores_m_pg','nb_vend_7_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_8_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_8_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_8_fld',24,'Estado'),
	('nb_vendedores_m_pg','nb_vend_8_fld',32,'select'),
	('nb_vendedores_m_pg','nb_vend_8_fld',36,'false'),
	('nb_vendedores_m_pg','nb_vend_8_fld',55,'../Events/ValoresCampo.php?campo=nb_estado_fld'),
	('nb_vendedores_m_pg','nb_vend_8_fld',58,'Seleccione estado'),
	('nb_vendedores_m_pg','nb_vend_8_fld',59,'false'),
	('nb_vendedores_m_pg','nb_vend_9_fld',11,'false'),
	('nb_vendedores_m_pg','nb_vend_9_fld',13,'string'),
	('nb_vendedores_m_pg','nb_vend_9_fld',24,'Observaciones'),
	('nb_vendedores_m_pg','nb_vend_9_fld',32,'textarea'),
	('nb_vendedores_m_pg','nb_vend_9_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_10_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_10_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_10_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_10_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_11_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_11_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_11_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_11_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_12_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_12_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_12_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_12_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_13_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_13_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_13_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_13_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_14_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_14_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_14_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_14_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_15_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_15_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_15_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_15_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_16_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_16_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_16_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_16_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_17_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_17_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_17_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_17_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_18_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_18_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_18_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_18_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_19_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_19_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_19_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_19_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_1_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_1_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_1_fld',24,'Id proveedor'),
	('nb_proveedores_m_pg','nb_prov_1_fld',36,'true'),
	('nb_proveedores_m_pg','nb_prov_20_fld',11,'campo 18'),
	('nb_proveedores_m_pg','nb_prov_20_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_20_fld',24,'campo'),
	('nb_proveedores_m_pg','nb_prov_20_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_2_fld',11,'true'),
	('nb_proveedores_m_pg','nb_prov_2_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_2_fld',24,'Tipo Documento'),
	('nb_proveedores_m_pg','nb_prov_2_fld',32,'select'),
	('nb_proveedores_m_pg','nb_prov_2_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_2_fld',55,'../Events/ValoresCampo.php?campo=nb_tipodoc_fld'),
	('nb_proveedores_m_pg','nb_prov_2_fld',58,'Seleccione Tipo Documento'),
	('nb_proveedores_m_pg','nb_prov_2_fld',59,'false'),
	('nb_proveedores_m_pg','nb_prov_3_fld',11,'true'),
	('nb_proveedores_m_pg','nb_prov_3_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_3_fld',24,'# Documento'),
	('nb_proveedores_m_pg','nb_prov_3_fld',32,'number'),
	('nb_proveedores_m_pg','nb_prov_3_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_4_fld',11,'true'),
	('nb_proveedores_m_pg','nb_prov_4_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_4_fld',24,'Nombre o Razon Social'),
	('nb_proveedores_m_pg','nb_prov_4_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_5_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_5_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_5_fld',24,'Direccion'),
	('nb_proveedores_m_pg','nb_prov_5_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_6_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_6_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_6_fld',24,'Telefono'),
	('nb_proveedores_m_pg','nb_prov_6_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_7_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_7_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_7_fld',24,'Email'),
	('nb_proveedores_m_pg','nb_prov_7_fld',32,'email'),
	('nb_proveedores_m_pg','nb_prov_7_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_8_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_8_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_8_fld',24,'Estado'),
	('nb_proveedores_m_pg','nb_prov_8_fld',32,'select'),
	('nb_proveedores_m_pg','nb_prov_8_fld',36,'false'),
	('nb_proveedores_m_pg','nb_prov_8_fld',55,'../Events/ValoresCampo.php?campo=nb_estado_fld'),
	('nb_proveedores_m_pg','nb_prov_8_fld',58,'Seleccione Estado'),
	('nb_proveedores_m_pg','nb_prov_8_fld',59,'false'),
	('nb_proveedores_m_pg','nb_prov_9_fld',11,'false'),
	('nb_proveedores_m_pg','nb_prov_9_fld',13,'string'),
	('nb_proveedores_m_pg','nb_prov_9_fld',24,'Observaciones'),
	('nb_proveedores_m_pg','nb_prov_9_fld',32,'textarea'),
	('nb_proveedores_m_pg','nb_prov_9_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_10_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_10_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_10_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_10_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_11_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_11_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_11_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_11_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_12_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_12_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_12_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_12_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_13_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_13_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_13_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_13_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_14_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_14_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_14_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_14_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_15_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_15_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_15_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_15_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_16_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_16_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_16_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_16_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_17_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_17_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_17_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_17_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_18_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_18_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_18_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_18_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_19_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_19_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_19_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_19_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_1_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_1_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_1_fld',24,'Id Producto'),
	('nb_productos_m_pg','nb_prod_1_fld',32,'number'),
	('nb_productos_m_pg','nb_prod_1_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_20_fld',11,'campo 18'),
	('nb_productos_m_pg','nb_prod_20_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_20_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_20_fld',36,'true'),
	('nb_productos_m_pg','nb_prod_2_fld',11,'true'),
	('nb_productos_m_pg','nb_prod_2_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_2_fld',24,'Descripcion'),
	('nb_productos_m_pg','nb_prod_2_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_3_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_3_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_3_fld',24,'Marca'),
	('nb_productos_m_pg','nb_prod_3_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_4_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_4_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_4_fld',24,'Modelo'),
	('nb_productos_m_pg','nb_prod_4_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_5_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_5_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_5_fld',24,'Observaciones'),
	('nb_productos_m_pg','nb_prod_5_fld',32,'textarea'),
	('nb_productos_m_pg','nb_prod_5_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_6_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_6_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_6_fld',24,'Unidad Medida'),
	('nb_productos_m_pg','nb_prod_6_fld',32,'select'),
	('nb_productos_m_pg','nb_prod_6_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_6_fld',55,'../Events/ValoresCampo.php?campo=nb_umed_fld'),
	('nb_productos_m_pg','nb_prod_6_fld',58,'Seleccione Tipo Medida'),
	('nb_productos_m_pg','nb_prod_6_fld',59,'false'),
	('nb_productos_m_pg','nb_prod_7_fld',11,'true'),
	('nb_productos_m_pg','nb_prod_7_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_7_fld',24,'Precio'),
	('nb_productos_m_pg','nb_prod_7_fld',32,'number'),
	('nb_productos_m_pg','nb_prod_7_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_8_fld',11,'true'),
	('nb_productos_m_pg','nb_prod_8_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_8_fld',24,'Iva'),
	('nb_productos_m_pg','nb_prod_8_fld',32,'number'),
	('nb_productos_m_pg','nb_prod_8_fld',36,'false'),
	('nb_productos_m_pg','nb_prod_9_fld',11,'false'),
	('nb_productos_m_pg','nb_prod_9_fld',13,'string'),
	('nb_productos_m_pg','nb_prod_9_fld',24,'campo'),
	('nb_productos_m_pg','nb_prod_9_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_10_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_10_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_10_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_10_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_11_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_11_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_11_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_11_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_12_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_12_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_12_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_12_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_13_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_13_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_13_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_13_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_14_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_14_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_14_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_14_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_15_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_15_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_15_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_15_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_16_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_16_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_16_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_16_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_17_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_17_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_17_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_17_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_18_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_18_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_18_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_18_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_19_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_19_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_19_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_19_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_1_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_1_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_1_fld',24,'Cod Inventario'),
	('nb_inventario_m_pg','nb_inve_1_fld',32,'number'),
	('nb_inventario_m_pg','nb_inve_1_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_20_fld',11,'campo 18'),
	('nb_inventario_m_pg','nb_inve_20_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_20_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_20_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_2_fld',11,'true'),
	('nb_inventario_m_pg','nb_inve_2_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_2_fld',24,'Id Producto'),
	('nb_inventario_m_pg','nb_inve_2_fld',32,'number'),
	('nb_inventario_m_pg','nb_inve_2_fld',36,'false'),
	('nb_inventario_m_pg','nb_inve_3_fld',11,'true'),
	('nb_inventario_m_pg','nb_inve_3_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_3_fld',24,'Cantidad'),
	('nb_inventario_m_pg','nb_inve_3_fld',32,'number'),
	('nb_inventario_m_pg','nb_inve_3_fld',36,'false'),
	('nb_inventario_m_pg','nb_inve_4_fld',6,'date'),
	('nb_inventario_m_pg','nb_inve_4_fld',11,'true'),
	('nb_inventario_m_pg','nb_inve_4_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_4_fld',24,'Fecha Ingreso '),
	('nb_inventario_m_pg','nb_inve_4_fld',36,'false'),
	('nb_inventario_m_pg','nb_inve_5_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_5_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_5_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_5_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_6_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_6_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_6_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_6_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_7_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_7_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_7_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_7_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_8_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_8_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_8_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_8_fld',36,'true'),
	('nb_inventario_m_pg','nb_inve_9_fld',11,'false'),
	('nb_inventario_m_pg','nb_inve_9_fld',13,'string'),
	('nb_inventario_m_pg','nb_inve_9_fld',24,'campo'),
	('nb_inventario_m_pg','nb_inve_9_fld',36,'true'),
	('nb_clientes_m_pg','nb_clie_1_fldX',11,'false'),
	('nb_clientes_m_pg','nb_clie_1_fldX',13,'string'),
	('nb_clientes_m_pg','nb_clie_1_fldX',24,'Id Cliente'),
	('nb_clientes_m_pg','nb_clie_1_fldX',29,'true'),
	('nb_vendedores_m_pg','nb_vend_1_fldX',11,'false'),
	...
	('nb_proveedores_m_pg','nb_prov_1_fldX',24,'Id proveedor'),
	('nb_proveedores_m_pg','nb_prov_1_fldX',29,'true'),
	('nb_productos_m_pg','nb_prod_1_fldX',11,'false'),
...
VALUES
	...
	('nb_clientes_v_pg','nb_clientes_m_pg'),
...
VALUES
	...
	('nb_clientes_m_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_clientes_m_pg',2,0,2,'Clientes','nb_clientes_pg','fa fa-user','N'),
	('nb_clientes_m_pg',3,2,1,'Ingreso Clientes','nb_clientes_pg','fa fa-plus','N'),
	('nb_clientes_m_pg',4,2,2,'Consulta Clientes','nb_clientes_v_pg','fa fa-search','N'),
	('nb_clientes_m_pg',5,0,3,'Vendedores','nb_vendedores_pg','fa fa-user','N'),
	('nb_clientes_m_pg',6,5,1,'Ingreso Vendedores','nb_vendedores_pg','fa fa-plus','N'),
	('nb_clientes_m_pg',7,5,2,'Consulta Vendedores','nb_vendedores_v_pg','fa fa-search','N'),
	('nb_clientes_m_pg',8,0,4,'Proveedores','nb_proveedores_pg','fa fa-user','N'),
	('nb_clientes_m_pg',9,8,1,'Ingreso Proveedores','nb_proveedores_pg','fa fa-plus','N'),
	('nb_clientes_m_pg',10,8,2,'Consulta Proveedores','nb_proveedores_v_pg','fa fa-search','N'),
	('nb_clientes_m_pg',11,0,5,'Productos','nb_productos_pg','fa fa-dot-circle-o','N'),
	('nb_clientes_m_pg',12,11,1,'Ingreso Productos','nb_productos_pg','fa fa-plus','N'),
	('nb_clientes_m_pg',13,11,2,'Consulta de Productos','nb_productos_v_pg','fa fa-search','N'),
	('nb_clientes_m_pg',14,0,6,'Inventario','nb_inventario_pg','fa fa-archive','N'),
	('nb_clientes_m_pg',15,14,1,'Ingreso Inventario','nb_inventario_pg','fa fa-plus','N'),
	('nb_clientes_m_pg',16,14,2,'Consulta Inventario','nb_inventario_v_pg','fa fa-search','N'),
	('nb_clientes_m_pg',17,0,7,'Facturacion','nb_facturacion_pg','fa fa-dollar','N'),
	('nb_clientes_m_pg',18,17,1,'Ingreso factura','nb_facturacion_pg','fa fa-plus','N'),
	('nb_clientes_m_pg',19,17,2,'Consulta Factura','nb_facturacion_v_pg','fa fa-search','N'),
	('nb_clientes_m_pg',20,0,8,'Reportes','nb_reporte_1_pg','fa fa-line-chart','N'),
	('nb_clientes_m_pg',21,20,1,'Facturacion Diaria','nb_reporte_1_pg','fa fa-area-chart','N'),
	('nb_clientes_m_pg',22,20,2,'Facturacion Mensual','nb_reporte_2_pg','fa fa-bar-chart','N'),
	('nb_clientes_m_pg',23,0,9,'Usuarios Software','nb_users_pg','fa fa-users','N'),
	('nb_clientes_m_pg',24,23,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_clientes_m_pg',25,23,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_clientes_m_pg',26,0,10,'Configuracion','home','fa fa-cog','N'),
	('nb_clientes_m_pg',27,26,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_clientes_m_pg',28,26,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_clientes_m_pg',29,0,11,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_vendedores_m_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_vendedores_m_pg',2,0,2,'Clientes','nb_clientes_pg','fa fa-user','N'),
	('nb_vendedores_m_pg',3,2,1,'Ingreso Clientes','nb_clientes_pg','fa fa-plus','N'),
	('nb_vendedores_m_pg',4,2,2,'Consulta Clientes','nb_clientes_v_pg','fa fa-search','N'),
	('nb_vendedores_m_pg',5,0,3,'Vendedores','nb_vendedores_pg','fa fa-user','N'),
	('nb_vendedores_m_pg',6,5,1,'Ingreso Vendedores','nb_vendedores_pg','fa fa-plus','N'),
	('nb_vendedores_m_pg',7,5,2,'Consulta Vendedores','nb_vendedores_v_pg','fa fa-search','N'),
	('nb_vendedores_m_pg',8,0,4,'Proveedores','nb_proveedores_pg','fa fa-user','N'),
	('nb_vendedores_m_pg',9,8,1,'Ingreso Proveedores','nb_proveedores_pg','fa fa-plus','N'),
	('nb_vendedores_m_pg',10,8,2,'Consulta Proveedores','nb_proveedores_v_pg','fa fa-search','N'),
	('nb_vendedores_m_pg',11,0,5,'Productos','nb_productos_pg','fa fa-dot-circle-o','N'),
	('nb_vendedores_m_pg',12,11,1,'Ingreso Productos','nb_productos_pg','fa fa-plus','N'),
	('nb_vendedores_m_pg',13,11,2,'Consulta de Productos','nb_productos_v_pg','fa fa-search','N'),
	('nb_vendedores_m_pg',14,0,6,'Inventario','nb_inventario_pg','fa fa-archive','N'),
	('nb_vendedores_m_pg',15,14,1,'Ingreso Inventario','nb_inventario_pg','fa fa-plus','N'),
	('nb_vendedores_m_pg',16,14,2,'Consulta Inventario','nb_inventario_v_pg','fa fa-search','N'),
	('nb_vendedores_m_pg',17,0,7,'Facturacion','nb_facturacion_pg','fa fa-dollar','N'),
	('nb_vendedores_m_pg',18,17,1,'Ingreso factura','nb_facturacion_pg','fa fa-plus','N'),
	('nb_vendedores_m_pg',19,17,2,'Consulta Factura','nb_facturacion_v_pg','fa fa-search','N'),
	('nb_vendedores_m_pg',20,0,8,'Reportes','nb_reporte_1_pg','fa fa-line-chart','N'),
	('nb_vendedores_m_pg',21,20,1,'Facturacion Diaria','nb_reporte_1_pg','fa fa-area-chart','N'),
	('nb_vendedores_m_pg',22,20,2,'Facturacion Mensual','nb_reporte_2_pg','fa fa-bar-chart','N'),
	('nb_vendedores_m_pg',23,0,9,'Usuarios Software','nb_users_pg','fa fa-users','N'),
	('nb_vendedores_m_pg',24,23,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_vendedores_m_pg',25,23,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_vendedores_m_pg',26,0,10,'Configuracion','home','fa fa-cog','N'),
	('nb_vendedores_m_pg',27,26,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_vendedores_m_pg',28,26,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_vendedores_m_pg',29,0,11,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_vendedores_m_pg',30,0,12,'Prueba','nb_prueba_pg','fa fa-cog','N'),
	('nb_proveedores_m_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_proveedores_m_pg',2,0,2,'Clientes','nb_clientes_pg','fa fa-user','N'),
	('nb_proveedores_m_pg',3,2,1,'Ingreso Clientes','nb_clientes_pg','fa fa-plus','N'),
	('nb_proveedores_m_pg',4,2,2,'Consulta Clientes','nb_clientes_v_pg','fa fa-search','N'),
	('nb_proveedores_m_pg',5,0,3,'Vendedores','nb_vendedores_pg','fa fa-user','N'),
	('nb_proveedores_m_pg',6,5,1,'Ingreso Vendedores','nb_vendedores_pg','fa fa-plus','N'),
	('nb_proveedores_m_pg',7,5,2,'Consulta Vendedores','nb_vendedores_v_pg','fa fa-search','N'),
	('nb_proveedores_m_pg',8,0,4,'Proveedores','nb_proveedores_pg','fa fa-user','N'),
	('nb_proveedores_m_pg',9,8,1,'Ingreso Proveedores','nb_proveedores_pg','fa fa-plus','N'),
	('nb_proveedores_m_pg',10,8,2,'Consulta Proveedores','nb_proveedores_v_pg','fa fa-search','N'),
	('nb_proveedores_m_pg',11,0,5,'Productos','nb_productos_pg','fa fa-dot-circle-o','N'),
	('nb_proveedores_m_pg',12,11,1,'Ingreso Productos','nb_productos_pg','fa fa-plus','N'),
	('nb_proveedores_m_pg',13,11,2,'Consulta de Productos','nb_productos_v_pg','fa fa-search','N'),
	('nb_proveedores_m_pg',14,0,6,'Inventario','nb_inventario_pg','fa fa-archive','N'),
	('nb_proveedores_m_pg',15,14,1,'Ingreso Inventario','nb_inventario_pg','fa fa-plus','N'),
	('nb_proveedores_m_pg',16,14,2,'Consulta Inventario','nb_inventario_v_pg','fa fa-search','N'),
	('nb_proveedores_m_pg',17,0,7,'Facturacion','nb_facturacion_pg','fa fa-dollar','N'),
	('nb_proveedores_m_pg',18,17,1,'Ingreso factura','nb_facturacion_pg','fa fa-plus','N'),
	('nb_proveedores_m_pg',19,17,2,'Consulta Factura','nb_facturacion_v_pg','fa fa-search','N'),
	('nb_proveedores_m_pg',20,0,8,'Reportes','nb_reporte_1_pg','fa fa-line-chart','N'),
	('nb_proveedores_m_pg',21,20,1,'Facturacion Diaria','nb_reporte_1_pg','fa fa-area-chart','N'),
	('nb_proveedores_m_pg',22,20,2,'Facturacion Mensual','nb_reporte_2_pg','fa fa-bar-chart','N'),
	('nb_proveedores_m_pg',23,0,9,'Usuarios Software','nb_users_pg','fa fa-users','N'),
	('nb_proveedores_m_pg',24,23,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_proveedores_m_pg',25,23,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_proveedores_m_pg',26,0,10,'Configuracion','home','fa fa-cog','N'),
	('nb_proveedores_m_pg',27,26,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_proveedores_m_pg',28,26,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_proveedores_m_pg',29,0,11,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_proveedores_m_pg',30,0,12,'Prueba','nb_prueba_pg','fa fa-cog','N'),
	('nb_productos_m_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_productos_m_pg',2,0,2,'Clientes','nb_clientes_pg','fa fa-user','N'),
	('nb_productos_m_pg',3,2,1,'Ingreso Clientes','nb_clientes_pg','fa fa-plus','N'),
	('nb_productos_m_pg',4,2,2,'Consulta Clientes','nb_clientes_v_pg','fa fa-search','N'),
	('nb_productos_m_pg',5,0,3,'Vendedores','nb_vendedores_pg','fa fa-user','N'),
	('nb_productos_m_pg',6,5,1,'Ingreso Vendedores','nb_vendedores_pg','fa fa-plus','N'),
	('nb_productos_m_pg',7,5,2,'Consulta Vendedores','nb_vendedores_v_pg','fa fa-search','N'),
	('nb_productos_m_pg',8,0,4,'Proveedores','nb_proveedores_pg','fa fa-user','N'),
	('nb_productos_m_pg',9,8,1,'Ingreso Proveedores','nb_proveedores_pg','fa fa-plus','N'),
	('nb_productos_m_pg',10,8,2,'Consulta Proveedores','nb_proveedores_v_pg','fa fa-search','N'),
	('nb_productos_m_pg',11,0,5,'Productos','nb_productos_pg','fa fa-dot-circle-o','N'),
	('nb_productos_m_pg',12,11,1,'Ingreso Productos','nb_productos_pg','fa fa-plus','N'),
	('nb_productos_m_pg',13,11,2,'Consulta de Productos','nb_productos_v_pg','fa fa-search','N'),
	('nb_productos_m_pg',14,0,6,'Inventario','nb_inventario_pg','fa fa-archive','N'),
	('nb_productos_m_pg',15,14,1,'Ingreso Inventario','nb_inventario_pg','fa fa-plus','N'),
	('nb_productos_m_pg',16,14,2,'Consulta Inventario','nb_inventario_v_pg','fa fa-search','N'),
	('nb_productos_m_pg',17,0,7,'Facturacion','nb_facturacion_pg','fa fa-dollar','N'),
	('nb_productos_m_pg',18,17,1,'Ingreso factura','nb_facturacion_pg','fa fa-plus','N'),
	('nb_productos_m_pg',19,17,2,'Consulta Factura','nb_facturacion_v_pg','fa fa-search','N'),
	('nb_productos_m_pg',20,0,8,'Reportes','nb_reporte_1_pg','fa fa-line-chart','N'),
	('nb_productos_m_pg',21,20,1,'Facturacion Diaria','nb_reporte_1_pg','fa fa-area-chart','N'),
	('nb_productos_m_pg',22,20,2,'Facturacion Mensual','nb_reporte_2_pg','fa fa-bar-chart','N'),
	('nb_productos_m_pg',23,0,9,'Usuarios Software','nb_users_pg','fa fa-users','N'),
	('nb_productos_m_pg',24,23,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_productos_m_pg',25,23,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
	('nb_productos_m_pg',26,0,10,'Configuracion','home','fa fa-cog','N'),
	('nb_productos_m_pg',27,26,1,'Cambio de Contrase&#241;a','nb_password_pg','fa fa-key','N'),
	('nb_productos_m_pg',28,26,2,'Ayuda','ayuda','fa fa-life-buoy','N'),
	('nb_productos_m_pg',29,0,11,'Cerrar sesion','login','fa fa-sign-out','N'),
	('nb_inventario_m_pg',1,0,1,'Home','home','fa fa-home','N'),
	('nb_inventario_m_pg',2,0,2,'Clientes','nb_clientes_pg','fa fa-user','N'),
	('nb_inventario_m_pg',3,2,1,'Ingreso Clientes','nb_clientes_pg','fa fa-plus','N'),
	('nb_inventario_m_pg',4,2,2,'Consulta Clientes','nb_clientes_v_pg','fa fa-search','N'),
	('nb_inventario_m_pg',5,0,3,'Vendedores','nb_vendedores_pg','fa fa-user','N'),
	('nb_inventario_m_pg',6,5,1,'Ingreso Vendedores','nb_vendedores_pg','fa fa-plus','N'),
	('nb_inventario_m_pg',7,5,2,'Consulta Vendedores','nb_vendedores_v_pg','fa fa-search','N'),
	('nb_inventario_m_pg',8,0,4,'Proveedores','nb_proveedores_pg','fa fa-user','N'),
	('nb_inventario_m_pg',9,8,1,'Ingreso Proveedores','nb_proveedores_pg','fa fa-plus','N'),
	('nb_inventario_m_pg',10,8,2,'Consulta Proveedores','nb_proveedores_v_pg','fa fa-search','N'),
	('nb_inventario_m_pg',11,0,5,'Productos','nb_productos_pg','fa fa-dot-circle-o','N'),
	('nb_inventario_m_pg',12,11,1,'Ingreso Productos','nb_productos_pg','fa fa-plus','N'),
	('nb_inventario_m_pg',13,11,2,'Consulta de Productos','nb_productos_v_pg','fa fa-search','N'),
	('nb_inventario_m_pg',14,0,6,'Inventario','nb_inventario_pg','fa fa-archive','N'),
	('nb_inventario_m_pg',15,14,1,'Ingreso Inventario','nb_inventario_pg','fa fa-plus','N'),
	('nb_inventario_m_pg',16,14,2,'Consulta Inventario','nb_inventario_v_pg','fa fa-search','N'),
	('nb_inventario_m_pg',17,0,7,'Facturacion','nb_facturacion_pg','fa fa-dollar','N'),
	('nb_inventario_m_pg',18,17,1,'Ingreso factura','nb_facturacion_pg','fa fa-plus','N'),
	('nb_inventario_m_pg',19,17,2,'Consulta Factura','nb_facturacion_v_pg','fa fa-search','N'),
	('nb_inventario_m_pg',20,0,8,'Reportes','nb_reporte_1_pg','fa fa-line-chart','N'),
	('nb_inventario_m_pg',21,20,1,'Facturacion Diaria','nb_reporte_1_pg','fa fa-area-chart','N'),
	('nb_inventario_m_pg',22,20,2,'Facturacion Mensual','nb_reporte_2_pg','fa fa-bar-chart','N'),
	('nb_inventario_m_pg',23,0,9,'Usuarios Software','nb_users_pg','fa fa-users','N'),
	('nb_inventario_m_pg',24,23,1,'Ingreso Usuarios','nb_users_pg','fa fa-plus','N'),
	('nb_inventario_m_pg',25,23,2,'Consulta Usuarios','nb_loginv_pg','fa fa-search','N'),
...
VALUES
	...
	('nb_clientes_m_pg','wizard','true','../Events/','nabuSave','1','post',''),
...
VALUES
	...
	('nb_inventario_m_pg',4),
	('nb_inventario_m_pg',5),
	('nb_inventario_m_pg',6),
	('nb_inventario_m_pg',7),
	('nb_inventario_m_pg',8),
	('nb_inventario_m_pg',9),
	('nb_inventario_m_pg',10),
	('nb_inventario_m_pg',12),
	('nb_inventario_m_pg',13),
	('nb_inventario_m_pg',15),
	('nb_inventario_m_pg',16),
	('nb_inventario_m_pg',17),
	('nb_inventario_m_pg',19),
	('nb_inventario_m_pg',22),
	('nb_inventario_pg',1),
	('nb_inventario_pg',2),
	('nb_inventario_pg',3),
	('nb_inventario_pg',4),
	...
	('nb_productos_m_pg',8),
	('nb_productos_m_pg',9),
	('nb_productos_m_pg',10),
	('nb_productos_m_pg',12),
	('nb_productos_m_pg',13),
	('nb_productos_m_pg',15),
	('nb_productos_m_pg',16),
	('nb_productos_m_pg',17),
	('nb_productos_m_pg',19),
	('nb_productos_m_pg',22),
	('nb_productos_pg',1),
	('nb_productos_pg',2),
	('nb_productos_pg',3),
	('nb_productos_pg',4),
	...
	('nb_proveedores_m_pg',1),
	('nb_proveedores_m_pg',2),
	('nb_proveedores_m_pg',3),
	('nb_proveedores_m_pg',4),
	('nb_proveedores_m_pg',5),
	('nb_proveedores_m_pg',6),
	('nb_proveedores_m_pg',7),
	('nb_proveedores_m_pg',8),
	('nb_proveedores_m_pg',9),
	('nb_proveedores_m_pg',10),
	('nb_proveedores_m_pg',12),
	('nb_proveedores_m_pg',13),
	('nb_proveedores_m_pg',15),
	('nb_proveedores_m_pg',16),
	('nb_proveedores_m_pg',17),
	('nb_proveedores_m_pg',19),
	('nb_proveedores_m_pg',22),
	('nb_proveedores_pg',1),
	('nb_proveedores_pg',2),
	('nb_proveedores_pg',3),
	('nb_proveedores_pg',4),
	...
	('nb_proveedores_v_pg',1),
	('nb_proveedores_v_pg',2),
	('nb_proveedores_v_pg',3),
	('nb_proveedores_v_pg',6),
	('nb_proveedores_v_pg',9),
	('nb_proveedores_v_pg',10),
	('nb_proveedores_v_pg',12),
	('nb_proveedores_v_pg',13),
	('nb_proveedores_v_pg',16),
	('nb_proveedores_v_pg',17),
	('nb_proveedores_v_pg',18),
	('nb_proveedores_v_pg',19),
	('nb_proveedores_v_pg',20),
	('nb_reporte_1_pg',1),
	('nb_reporte_1_pg',2),
	('nb_reporte_1_pg',3),
	('nb_reporte_1_pg',6),
	...
	('nb_users_pg',19),
	('nb_users_pg',22),
	('nb_vendedores_m_pg',1),
	('nb_vendedores_m_pg',2),
	('nb_vendedores_m_pg',3),
	('nb_vendedores_m_pg',4),
	('nb_vendedores_m_pg',5),
	('nb_vendedores_m_pg',6),
	('nb_vendedores_m_pg',7),
	('nb_vendedores_m_pg',8),
	('nb_vendedores_m_pg',9),
	('nb_vendedores_m_pg',10),
	('nb_vendedores_m_pg',12),
	('nb_vendedores_m_pg',13),
	('nb_vendedores_m_pg',15),
	('nb_vendedores_m_pg',16),
	('nb_vendedores_m_pg',17),
	('nb_vendedores_m_pg',19),
	('nb_vendedores_m_pg',22),
	('nb_vendedores_pg',1),
	('nb_vendedores_pg',2),
	('nb_vendedores_pg',3),
	('nb_vendedores_pg',4),
	...
	('nb_vendedores_pg',19),
	('nb_vendedores_pg',22),
	('nb_vendedores_v_pg',1),
	('nb_vendedores_v_pg',2),
	('nb_vendedores_v_pg',3),
	('nb_vendedores_v_pg',6),
	('nb_vendedores_v_pg',9),
	('nb_vendedores_v_pg',10),
	('nb_vendedores_v_pg',12),
	('nb_vendedores_v_pg',13),
	('nb_vendedores_v_pg',16),
	('nb_vendedores_v_pg',17),
	('nb_vendedores_v_pg',18),
	('nb_vendedores_v_pg',19),
	('nb_vendedores_v_pg',20);
...
VALUES
	...
	('nb_vendedores_v_pg','Consulta Vendedores','dataGrids','datagrid',NULL,NULL,'false'),
	('nb_proveedores_v_pg','Consulta Proveedores','dataGrids','datagrid',NULL,NULL,'false'),
	('nb_clientes_m_pg','Administracion de Clientes','forms','alpaca','bootstrap-edit-horizontal',NULL,'false'),
...
VALUES
	...
	('nb_clientes_m_pg','Clientes',NULL,'object'),
...
VALUES
	('nbd_user_tbl','nbd_descr_fld','string',255,'N','N',NULL),
	('nbd_user_tbl','nbd_email_fld','string',255,'Y','N',NULL),
	('nbd_role_user_tbl','nbd_id_user_fld','number',11,'Y','N',NULL),
	('nbd_user_tbl','nbd_id_user_fld','number',11,'Y','N',NULL),
	('nbd_user_tbl','nbd_password_fld','string',255,'N','N',NULL),
	...
	('nb_clientes_tbl','nb_clie_1_fld','string',255,'Y','N',NULL),
	...
	('nbd_user_tbl','nb_estado_fld','number',2,'N','N',NULL),
	...
	('nb_inventario_tbl','nb_inve_1_fld','string',255,'Y','N',NULL),
	...
	('nb_productos_tbl','nb_prod_1_fld','string',255,'Y','N',NULL),
	...
	('nb_proveedores_tbl','nb_prov_10_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_11_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_12_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_13_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_14_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_15_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_16_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_17_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_18_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_19_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_1_fld','string',255,'Y','N',NULL),
	('nb_proveedores_tbl','nb_prov_20_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_2_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_3_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_4_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_5_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_6_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_7_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_8_fld','string',255,'N','N',NULL),
	('nb_proveedores_tbl','nb_prov_9_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_10_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_11_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_12_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_13_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_14_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_15_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_16_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_17_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_18_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_19_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_1_fld','string',255,'Y','N',NULL),
	('nb_vendedores_tbl','nb_vend_20_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_2_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_3_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_4_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_5_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_6_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_7_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_8_fld','string',255,'N','N',NULL),
	('nb_vendedores_tbl','nb_vend_9_fld','string',255,'N','N',NULL);
...
VALUES
	...
	(5,'nb_proveedores_pg','nb_prov_5_fld',2,1),
	(5,'nb_vendedores_pg','nb_vend_5_fld',2,1),
	...
	(6,'nb_proveedores_pg','nb_prov_6_fld',2,2),
	(6,'nb_vendedores_pg','nb_vend_6_fld',2,2),
	...
	(7,'nb_proveedores_pg','nb_prov_7_fld',2,3),
	(7,'nb_vendedores_pg','nb_vend_7_fld',2,3),
	...
	(8,'nb_proveedores_pg','nb_prov_8_fld',3,1),
	(8,'nb_vendedores_pg','nb_vend_8_fld',3,1),
	...
	(9,'nb_proveedores_pg','nb_prov_9_fld',3,2),
	(9,'nb_vendedores_pg','nb_vend_9_fld',3,2),
	...
	(10,'nb_proveedores_pg','nb_prov_10_fld',4,1),
	(10,'nb_vendedores_pg','nb_vend_10_fld',4,1),
	...
	(11,'nb_proveedores_pg','nb_prov_11_fld',4,2),
	(11,'nb_vendedores_pg','nb_vend_11_fld',4,2),
	...
	(12,'nb_proveedores_pg','nb_prov_12_fld',4,3),
	(12,'nb_vendedores_pg','nb_vend_12_fld',4,3),
	...
	(13,'nb_proveedores_pg','nb_prov_13_fld',4,4),
	(13,'nb_vendedores_pg','nb_vend_13_fld',4,4),
	...
	(14,'nb_proveedores_pg','nb_prov_14_fld',4,5),
	(14,'nb_vendedores_pg','nb_vend_14_fld',4,5),
	...
	(15,'nb_proveedores_pg','nb_prov_15_fld',4,6),
	(15,'nb_vendedores_pg','nb_vend_15_fld',4,6),
	...
	(16,'nb_proveedores_pg','nb_prov_16_fld',4,7),
	(16,'nb_vendedores_pg','nb_vend_16_fld',4,7),
	...
	(17,'nb_proveedores_pg','nb_prov_17_fld',4,8),
	(17,'nb_vendedores_pg','nb_vend_17_fld',4,8),
	...
	(18,'nb_proveedores_pg','nb_prov_18_fld',4,9),
	(18,'nb_vendedores_pg','nb_vend_18_fld',4,9),
	...
	(19,'nb_proveedores_pg','nb_prov_19_fld',4,10),
	(19,'nb_vendedores_pg','nb_vend_19_fld',4,10),
	...
	(20,'nb_proveedores_pg','nb_prov_20_fld',4,11),
	(20,'nb_vendedores_pg','nb_vend_20_fld',4,11),
	(1,'nb_clientes_m_pg','nb_clie_1_fldX',1,1),
	(2,'nb_clientes_m_pg','nb_clie_2_fld',1,2),
	(3,'nb_clientes_m_pg','nb_clie_3_fld',1,3),
	(4,'nb_clientes_m_pg','nb_clie_4_fld',1,4),
	(5,'nb_clientes_m_pg','nb_clie_5_fld',1,5),
	(6,'nb_clientes_m_pg','nb_clie_6_fld',1,6),
	(7,'nb_clientes_m_pg','nb_clie_7_fld',2,1),
	(8,'nb_clientes_m_pg','nb_clie_8_fld',2,2),
	(9,'nb_clientes_m_pg','nb_clie_9_fld',2,3),
	(10,'nb_clientes_m_pg','nb_clie_10_fld',2,4),
	(11,'nb_clientes_m_pg','nb_clie_11_fld',3,1),
	(12,'nb_clientes_m_pg','nb_clie_12_fld',3,2),
	(13,'nb_clientes_m_pg','nb_clie_13_fld',3,3),
	(14,'nb_clientes_m_pg','nb_clie_14_fld',3,4),
	(15,'nb_clientes_m_pg','nb_clie_15_fld',3,5),
	(16,'nb_clientes_m_pg','nb_clie_16_fld',4,1),
	(17,'nb_clientes_m_pg','nb_clie_17_fld',4,2),
	(18,'nb_clientes_m_pg','nb_clie_18_fld',4,3),
	(19,'nb_clientes_m_pg','nb_clie_19_fld',4,4),
	(20,'nb_clientes_m_pg','nb_clie_20_fld',4,5),
	(1,'nb_vendedores_m_pg','nb_vend_1_fldX',1,1),
	(2,'nb_vendedores_m_pg','nb_vend_2_fld',1,2),
	(3,'nb_vendedores_m_pg','nb_vend_3_fld',1,3),
	(4,'nb_vendedores_m_pg','nb_vend_4_fld',1,4),
	(5,'nb_vendedores_m_pg','nb_vend_5_fld',2,1),
	(6,'nb_vendedores_m_pg','nb_vend_6_fld',2,2),
	(7,'nb_vendedores_m_pg','nb_vend_7_fld',2,3),
	(8,'nb_vendedores_m_pg','nb_vend_8_fld',3,1),
	(9,'nb_vendedores_m_pg','nb_vend_9_fld',3,2),
	(10,'nb_vendedores_m_pg','nb_vend_10_fld',4,1),
	(11,'nb_vendedores_m_pg','nb_vend_11_fld',4,2),
	(12,'nb_vendedores_m_pg','nb_vend_12_fld',4,3),
	(13,'nb_vendedores_m_pg','nb_vend_13_fld',4,4),
	(14,'nb_vendedores_m_pg','nb_vend_14_fld',4,5),
	(15,'nb_vendedores_m_pg','nb_vend_15_fld',4,6),
	(16,'nb_vendedores_m_pg','nb_vend_16_fld',4,7),
	(17,'nb_vendedores_m_pg','nb_vend_17_fld',4,8),
	(18,'nb_vendedores_m_pg','nb_vend_18_fld',4,9),
	(19,'nb_vendedores_m_pg','nb_vend_19_fld',4,10),
	(20,'nb_vendedores_m_pg','nb_vend_20_fld',4,11),
	(1,'nb_proveedores_m_pg','nb_prov_1_fldX',1,1),
	(2,'nb_proveedores_m_pg','nb_prov_2_fld',1,2),
	(3,'nb_proveedores_m_pg','nb_prov_3_fld',1,3),
	(4,'nb_proveedores_m_pg','nb_prov_4_fld',1,4),
	(5,'nb_proveedores_m_pg','nb_prov_5_fld',2,1),
	(6,'nb_proveedores_m_pg','nb_prov_6_fld',2,2),
	(7,'nb_proveedores_m_pg','nb_prov_7_fld',2,3),
	(8,'nb_proveedores_m_pg','nb_prov_8_fld',3,1),
	(9,'nb_proveedores_m_pg','nb_prov_9_fld',3,2),
	(10,'nb_proveedores_m_pg','nb_prov_10_fld',4,1),
	(11,'nb_proveedores_m_pg','nb_prov_11_fld',4,2),
	(12,'nb_proveedores_m_pg','nb_prov_12_fld',4,3),
	(13,'nb_proveedores_m_pg','nb_prov_13_fld',4,4),
	(14,'nb_proveedores_m_pg','nb_prov_14_fld',4,5),
	(15,'nb_proveedores_m_pg','nb_prov_15_fld',4,6),
	(16,'nb_proveedores_m_pg','nb_prov_16_fld',4,7),
	(17,'nb_proveedores_m_pg','nb_prov_17_fld',4,8),
	(18,'nb_proveedores_m_pg','nb_prov_18_fld',4,9),
	(19,'nb_proveedores_m_pg','nb_prov_19_fld',4,10),
	(20,'nb_proveedores_m_pg','nb_prov_20_fld',4,11),
	(1,'nb_productos_m_pg','nb_prod_1_fldX',1,1),
	(2,'nb_productos_m_pg','nb_prod_2_fld',1,2),
	(3,'nb_productos_m_pg','nb_prod_3_fld',1,3),
	(4,'nb_productos_m_pg','nb_prod_4_fld',1,4),
	(5,'nb_productos_m_pg','nb_prod_5_fld',1,5),
	(6,'nb_productos_m_pg','nb_prod_6_fld',2,1),
	(7,'nb_productos_m_pg','nb_prod_7_fld',2,2),
	(8,'nb_productos_m_pg','nb_prod_8_fld',2,3),
	(9,'nb_productos_m_pg','nb_prod_9_fld',2,4),
	(10,'nb_productos_m_pg','nb_prod_10_fld',2,5),
	(11,'nb_productos_m_pg','nb_prod_11_fld',3,1),
	(12,'nb_productos_m_pg','nb_prod_12_fld',3,2),
	(13,'nb_productos_m_pg','nb_prod_13_fld',3,3),
	(14,'nb_productos_m_pg','nb_prod_14_fld',3,4),
	(15,'nb_productos_m_pg','nb_prod_15_fld',3,5),
	(16,'nb_productos_m_pg','nb_prod_16_fld',4,1),
	(17,'nb_productos_m_pg','nb_prod_17_fld',4,2),
	(18,'nb_productos_m_pg','nb_prod_18_fld',4,3),
	(19,'nb_productos_m_pg','nb_prod_19_fld',4,4),
	(20,'nb_productos_m_pg','nb_prod_20_fld',4,5),
	(1,'nb_inventario_m_pg','nb_inve_1_fldX',1,1),
	(2,'nb_inventario_m_pg','nb_inve_2_fld',1,2),
	(3,'nb_inventario_m_pg','nb_inve_3_fld',1,3),
	(4,'nb_inventario_m_pg','nb_inve_4_fld',1,4),
	(5,'nb_inventario_m_pg','nb_inve_5_fld',2,2),
	(6,'nb_inventario_m_pg','nb_inve_6_fld',2,3),
	(7,'nb_inventario_m_pg','nb_inve_7_fld',2,4),
	(8,'nb_inventario_m_pg','nb_inve_8_fld',2,5),
	(9,'nb_inventario_m_pg','nb_inve_9_fld',2,6),
	(10,'nb_inventario_m_pg','nb_inve_10_fld',2,7),
	(11,'nb_inventario_m_pg','nb_inve_11_fld',3,1),
	(12,'nb_inventario_m_pg','nb_inve_12_fld',3,2),
	(13,'nb_inventario_m_pg','nb_inve_13_fld',3,3),
	(14,'nb_inventario_m_pg','nb_inve_14_fld',3,4),
	(15,'nb_inventario_m_pg','nb_inve_15_fld',3,5),
	(16,'nb_inventario_m_pg','nb_inve_16_fld',4,1),
...
VALUES
	...
	(1,'nb_facturacion_pg','submit','Detalle',NULL,NULL),
	(1,'nb_inventario_pg','submit','Guardar',NULL,NULL),
	(1,'nb_password_pg','submit','Actualizar',NULL,NULL),
	(1,'nb_productos_pg','submit','Guardar',NULL,NULL),
	(1,'nb_proveedores_pg','submit','Guardar',NULL,NULL),
	(1,'nb_usersm_pg','submit','Actualizar',NULL,NULL),
	(1,'nb_users_pg','submit','Guardar',NULL,NULL),
	(1,'nb_vendedores_pg','submit','Guardar',NULL,NULL),
	(2,'nb_clientes_pg','previous','Atras',NULL,NULL),
	(2,'nb_facturacion_pg','previous','Atras',NULL,NULL),
	(2,'nb_inventario_pg','previous','Atras',NULL,NULL),
	(2,'nb_productos_pg','previous','Atras',NULL,NULL),
	(2,'nb_proveedores_pg','previous','Atras',NULL,NULL),
	(2,'nb_vendedores_pg','previous','Atras',NULL,NULL),
	(3,'nb_clientes_pg','next','Siguiente',NULL,NULL),
	(3,'nb_facturacion_pg','next','Siguiente',NULL,NULL),
	(3,'nb_inventario_pg','next','Siguiente',NULL,NULL),
	(3,'nb_productos_pg','next','Siguiente',NULL,NULL),
	(3,'nb_proveedores_pg','next','Siguiente',NULL,NULL),
	(3,'nb_vendedores_pg','next','Siguiente',NULL,NULL),
	(1,'nb_clientes_m_pg','submit','Actualizar',NULL,NULL),
	(2,'nb_clientes_m_pg','previous','Atras',NULL,NULL),
	(3,'nb_clientes_m_pg','next','Siguiente',NULL,NULL),
	(1,'nb_vendedores_m_pg','submit','Actualizar',NULL,NULL),
	(2,'nb_vendedores_m_pg','previous','Atras',NULL,NULL),
	(3,'nb_vendedores_m_pg','next','Siguiente',NULL,NULL),
	(1,'nb_proveedores_m_pg','submit','Actualizar',NULL,NULL),
	(2,'nb_proveedores_m_pg','previous','Atras',NULL,NULL),
	(3,'nb_proveedores_m_pg','next','Siguiente',NULL,NULL),
	(1,'nb_productos_m_pg','submit','Actualizar',NULL,NULL),
	(2,'nb_productos_m_pg','previous','Atras',NULL,NULL),
...
VALUES
	...
	(2,'nb_proveedores_pg','Proveedores','Dato Localizacion'),
	(2,'nb_vendedores_pg','Vendedor','Datos Contacto'),
	(3,'nb_clientes_pg','Otros Datos','Observaciones'),
	(3,'nb_facturacion_pg','Factura','Detalle'),
	(3,'nb_proveedores_pg','Otros Datos','Observaciones'),
	(3,'nb_vendedores_pg','Otros Datos','Observaciones'),
	(1,'nb_clientes_m_pg','Datos Basicos','Identificacion'),
	(2,'nb_clientes_m_pg','Datos Contacto','Ubicacion'),
	(3,'nb_clientes_m_pg','Otros Datos','Observaciones'),
	(1,'nb_vendedores_m_pg','Vendedor','Datos Basicos'),
	(2,'nb_vendedores_m_pg','Vendedor','Datos Contacto'),
	(3,'nb_vendedores_m_pg','Otros Datos','Observaciones'),
	(1,'nb_proveedores_m_pg','Proveedores','Datos Basicos'),
	(2,'nb_proveedores_m_pg','Proveedores','Dato Localizacion'),
...
VALUES
	...
	(10,'nb_clientes_pg','Clientes',NULL,'true'),
...
FROM (`nb_productos_tbl` `a` left join `nb_value_tbl` `b` on(((`b`.`nb_id_pr_schema_fld` = 'nb_umed_fld') and (`a`.`nb_prod_6_fld` = `b`.`nb_id_value_fld`))));
...
FROM ((`nb_vendedores_tbl` `a` join `nb_value_tbl` `b`) join `nb_value_tbl` `c`) where ((`b`.`nb_id_pr_schema_fld` = 'nb_tipodoc_fld') and (`a`.`nb_vend_2_fld` = `b`.`nb_id_value_fld`) and (`c`.`nb_id_pr_schema_fld` = 'nb_estado_fld') and (`a`.`nb_vend_8_fld` = `c`.`nb_id_value_fld`));
...
AS SELECT
   ...
   `c`.`nb_value_fld` AS `Estado`
FROM ((`nb_clientes_tbl` `a` join `nb_value_tbl` `b`) join `nb_value_tbl` `c`) where ((`b`.`nb_id_pr_schema_fld` = 'nb_tipodoc_fld') and (`a`.`nb_clie_2_fld` = `b`.`nb_id_value_fld`) and (`c`.`nb_id_pr_schema_fld` = 'nb_estado_fld') and (`a`.`nb_clie_11_fld` = `c`.`nb_id_value_fld`));
...
AS SELECT
   ...
   `c`.`nb_value_fld` AS `Estado`
FROM ((`nb_proveedores_tbl` `a` join `nb_value_tbl` `b`) join `nb_value_tbl` `c`) where ((`b`.`nb_id_pr_schema_fld` = 'nb_tipodoc_fld') and (`a`.`nb_prov_2_fld` = `b`.`nb_id_value_fld`) and (`c`.`nb_id_pr_schema_fld` = 'nb_estado_fld') and (`a`.`nb_prov_8_fld` = `c`.`nb_id_value_fld`));
